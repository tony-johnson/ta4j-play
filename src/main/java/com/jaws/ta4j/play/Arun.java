...
public class Arun {
    ...
    public static void main(String[] args) {
        ...
        for (String ticker : SP500_symbol) {
            if (ticker.contains(".")) continue;
            if (ticker.equals("MMV")) continue;
    ...
    public static double test(String ticker) {
        ...
        QuandlTicksLoader.QuandlDataFeed quandl = new QuandlTicksLoader.QuandlDataFeed("WIKI/"+ticker, DateTime.parse("2015-09-01"), DateTime.parse("2017-09-01"));
        ...
        SMAIndicator ema = new SMAIndicator(diff,9);
